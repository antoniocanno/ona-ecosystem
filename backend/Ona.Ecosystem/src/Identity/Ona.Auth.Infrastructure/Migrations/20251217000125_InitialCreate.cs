    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnlockUserTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnlockUserTokens_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailVerificationTokens_IsRevoked",
                table: "EmailVerificationTokens",
                column: "IsRevoked");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordResetTokens_IsRevoked",
                table: "PasswordResetTokens",
                column: "IsRevoked");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnlockUserTokens_ExpiresAt",
                table: "UnlockUserTokens",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_UnlockUserTokens_IsRevoked",
                table: "UnlockUserTokens",
                column: "IsRevoked");

            migrationBuilder.CreateIndex(
                name: "IX_UnlockUserTokens_Token",
                table: "UnlockUserTokens",
                column: "Token",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UnlockUserTokens_UserId",
                table: "UnlockUserTokens",
                column: "UserId");
